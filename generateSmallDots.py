# generate small .dot files to give as input to gephi (about 10k edges)
...
def main():
    ...
    for row in sheet.iter_rows(values_only=True, max_row=10000):
        temp_dict = {}
    ...
    graph.write("dots/small"+filename+'.dot')
